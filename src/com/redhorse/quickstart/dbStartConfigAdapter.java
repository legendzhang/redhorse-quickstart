 ...
 */
public class dbStartConfigAdapter {
	public static final String KEY_ROWID = "_id";
	public static final String KEY_PKGNAME = "pkgname";
	public static final String KEY_APPNAME = "appname";
	public static final String KEY_CONTENT = "content";
	private static final String TAG = "startconfig";
	private static final String DATABASE_NAME = "quickstart";
	private static final String DATABASE_TABLE = "start";
	private static final int DATABASE_VERSION = 1;

	/*
	 * create table SQL
	 */
	private static final String DATABASE_CREATE = "create table start (_id integer primary key autoincrement, "
	 ...
	 */
	public dbStartConfigAdapter(Context ctx) {
		this.context = ctx;
	 ...
	 * Open DB
	 */
	public dbStartConfigAdapter open() throws SQLException {
